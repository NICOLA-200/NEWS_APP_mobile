...
const Signup : React.FC = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={{ color: "#4E4B66" }}>Signup to get started</Text>
      ...
      <Text style={{ textAlign: 'center', marginTop: 20 }}>Already have an account? <Link href="login" style={{ color: '#1877F2', fontWeight: '600' }}>Login</Link></Text>
    </SafeAreaView>
  );
};
